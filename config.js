...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? ' زياد بتاع شبرا 👑' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? ' زياد بتاع شبرا 👑' : process.env.PACK_INFO.split(";")[1],
